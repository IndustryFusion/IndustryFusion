...
@Component({
  selector: 'app-asset-type-template-wizard-shared-field',
  templateUrl: './asset-type-template-wizard-shared-field.component.html',
  styleUrls: ['./asset-type-template-wizard-shared-field.component.scss']
})
export class AssetTypeTemplateWizardSharedFieldComponent implements OnInit {
