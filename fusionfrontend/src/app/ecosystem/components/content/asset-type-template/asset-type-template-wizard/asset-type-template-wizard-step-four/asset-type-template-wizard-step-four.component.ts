...
@Component({
  selector: 'app-asset-type-template-wizard-step-four',
  templateUrl: './asset-type-template-wizard-step-four.component.html',
  styleUrls: ['./asset-type-template-wizard-step-four.component.scss']
})
export class AssetTypeTemplateWizardStepFourComponent implements OnInit {
