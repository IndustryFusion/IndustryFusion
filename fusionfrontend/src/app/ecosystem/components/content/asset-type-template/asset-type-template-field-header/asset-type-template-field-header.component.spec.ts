...
describe('AssetTypeTemplateFieldHeaderComponent', () => {
  ...
  let fixture: ComponentFixture<AssetTypeTemplateFieldHeaderComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ AssetTypeTemplateFieldHeaderComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(AssetTypeTemplateFieldHeaderComponent);
