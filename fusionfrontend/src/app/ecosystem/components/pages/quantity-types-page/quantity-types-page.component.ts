...
@Component({
  selector: 'app-quantity-types-page',
  templateUrl: './quantity-types-page.component.html',
  styleUrls: ['./quantity-types-page.component.scss']
})
export class QuantityTypesPageComponent implements OnInit {
