...
export class AssetTypeTemplatesResolver implements Resolve<AssetTypeTemplate[]> {
  constructor(private assetTypeTemplateService: AssetTypeTemplateService) { }

  resolve(): Observable<AssetTypeTemplate[]> {
    return this.assetTypeTemplateService.getItems();
  }
}
