...
package io.fusion.fusiongatewayapp.dto;
...
public class MetricsDataDto {
    ...
    @JsonCreator
    public MetricsDataDto() {
        super();
    }

    private MetricsDataDto(Builder builder) {
    ...
    public static final class Builder {
        ...
        public MetricsDataDto build() {
            return new MetricsDataDto(this);
        }
    }
}
